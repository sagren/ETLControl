...
CREATE TABLE ETLControl.BatchControl(
	...
	BatchControlTypeKey [int] NOT NULL,
...
CREATE TABLE ETLControl.BatchControlType(
	BatchControlTypeID [int] IDENTITY(1,1) NOT NULL,
...
GO
*/
ETL Metadata - MS SQL.txt
Displaying ETL Metadata - MS SQL.txt.
