...
if (select object_id('OutSystems.OSSYS_ROLE')) is null
CREATE TABLE [OutSystems].[OSSYS_ROLE](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSSYS_USER')) is null
CREATE TABLE [OutSystems].[OSSYS_USER](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_26Y_COMPANY')) is null
CREATE TABLE [OutSystems].[OSUSR_26Y_COMPANY](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_26Y_COMPANYSITE')) is null
CREATE TABLE [OutSystems].[OSUSR_26Y_COMPANYSITE](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_26y_Dependant')) is null
CREATE TABLE [OutSystems].[OSUSR_26y_Dependant](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_26y_EMPLOYEE')) is null
CREATE TABLE [OutSystems].[OSUSR_26y_EMPLOYEE](
	[ID] [bigint] NOT NULL,
	[COMPANYID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_5IF_BASICSTATUS')) is null
CREATE TABLE [OutSystems].[OSUSR_5IF_BASICSTATUS](
	[ID] [int] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_5IF_CALLERROLETYPE')) is null
CREATE TABLE [OutSystems].[OSUSR_5IF_CALLERROLETYPE](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_5IF_CASECLIENTSTATISFACTIONSURVEY')) is null
CREATE TABLE [OutSystems].[OSUSR_5IF_CASECLIENTSTATISFACTIONSURVEY](
	[ID] [bigint] NOT NULL,
	[CASEID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_5IF_CASECLOSURE')) is null
CREATE TABLE [OutSystems].[OSUSR_5IF_CASECLOSURE](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_5IF_CASEFILE')) is null
CREATE TABLE [OutSystems].[OSUSR_5IF_CASEFILE](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_5if_CasePreferenceCriteria')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_CasePreferenceCriteria](
	[ID] [bigint] NOT NULL,
	[CASEID] [bigint] NULL,
	...
	[LATITUDE_1] [decimal](37, 8) NULL,
	[LONGITUDE_1] [decimal](37, 8) NULL,
	[LOCATION_2] [nvarchar](250) NULL,
	[LATITUDE_2] [decimal](37, 8) NULL,
	[LONGITUDE_2] [decimal](37, 8) NULL,
	[LOCATION_3] [nvarchar](250) NULL,
	[LATITUDE_3] [decimal](37, 8) NULL,
	[LONGITUDE_3] [decimal](37, 8) NULL,
...
if (select object_id('OutSystems.OSUSR_5if_CaseSessionNotes')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_CaseSessionNotes](
	[ID] [bigint] NOT NULL,
	[CASEID] [bigint] NULL,
	[CASESESSIONID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_DeliveryMethod1')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_DeliveryMethod1](
	[ID] [int] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_5if_EmotionalState')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_EmotionalState](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_FA_Case_Session')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_FA_Case_Session](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_5if_IntakeAssement')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_IntakeAssement](
	[ID] [bigint] NOT NULL,
	[DESCRIPTION] [nvarchar](250) NULL,
...
if (select object_id('OutSystems.OSUSR_5if_IntakePerson')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_IntakePerson](
	[ID] [int] NOT NULL,
	[EMPLOYEEID] [int] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_ProblemCategory')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_ProblemCategory](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](100) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_ProblemType')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_ProblemType](
	[ID] [int] NOT NULL,
	[PROBLEMCATEGORYID] [int] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_RefferalType')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_RefferalType](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_Request')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_Request](
	[ID] [bigint] NOT NULL,
	[CASEID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_RiskType')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_RiskType](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_RiskType1')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_RiskType1](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_SessionClosure')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_SessionClosure](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_TrackingStatus')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_TrackingStatus](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_5if_WorkImpactStatus')) is null
CREATE TABLE [OutSystems].[OSUSR_5if_WorkImpactStatus](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_BZW_AGEGROUP')) is null
CREATE TABLE [OutSystems].[OSUSR_BZW_AGEGROUP](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_BZW_COMPANYBUSINESSUNIT')) is null
CREATE TABLE [OutSystems].[OSUSR_BZW_COMPANYBUSINESSUNIT](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_bzw_CompanyDivision')) is null
CREATE TABLE [OutSystems].[OSUSR_bzw_CompanyDivision](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_BZW_COMPANYREGION')) is null

CREATE TABLE [OutSystems].[OSUSR_BZW_COMPANYREGION](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_bzw_ContractService')) is null
CREATE TABLE [OutSystems].[OSUSR_bzw_ContractService](
	[ID] [bigint] NOT NULL,
	[CONTRACTID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_bzw_EmployeeLevel1')) is null
CREATE TABLE [OutSystems].[OSUSR_bzw_EmployeeLevel1](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_bzw_IndustrySector')) is null
CREATE TABLE [OutSystems].[OSUSR_bzw_IndustrySector](
	[ID] [int] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_bzw_Sector')) is null
CREATE TABLE [OutSystems].[OSUSR_bzw_Sector](
	[ID] [int] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_bzw_Services')) is null
CREATE TABLE [OutSystems].[OSUSR_bzw_Services](
	[ID] [bigint] NOT NULL,
	[NAME] [nvarchar](150) NULL,
	[ISACTIVE] [bit] NULL,
	[DATETIMECREATED] [datetime] NULL,
...
if (select object_id('OutSystems.OSUSR_CCY_USERROLES')) is null
CREATE TABLE [OutSystems].[OSUSR_CCY_USERROLES](
	[ID] [bigint] NOT NULL,
	[USERID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_CWI_ASSESSMENT')) is null
CREATE TABLE [OutSystems].[OSUSR_CWI_ASSESSMENT](
	[ID] [bigint] NOT NULL,
	[PROBLEMCATEGORYID] [int] NULL,
	[PROBLEMTYPEID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_EW4_ACCESSMETHOD')) is null
CREATE TABLE [OutSystems].[OSUSR_EW4_ACCESSMETHOD](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_EW4_CASEINTERVENTIONADDRESS')) is null
CREATE TABLE [OutSystems].[OSUSR_EW4_CASEINTERVENTIONADDRESS](
	[ID] [bigint] NOT NULL,
	[INTAKEASSESSMENTID] [bigint] NULL,
	[CASEID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_EW4_CASELINK')) is null
CREATE TABLE [OutSystems].[OSUSR_EW4_CASELINK](
	[ID] [bigint] NOT NULL,
	[CREATEDBY] [int] NULL,
	[CREATEDON] [datetime] NULL,
	[ISACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_EW4_CASESESSIONINTERVENTION')) is null
CREATE TABLE [OutSystems].[OSUSR_EW4_CASESESSIONINTERVENTION](
	[ID] [bigint] NOT NULL,
	[INTAKEASSESSMENTID] [bigint] NULL,
	[CASEID] [bigint] NULL,
	[CASESESSIONID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_EW4_CASEUSER')) is null
CREATE TABLE [OutSystems].[OSUSR_EW4_CASEUSER](
	[ID] [bigint] NOT NULL,
	[CASEID] [bigint] NULL,
	[ROLEID] [bigint] NULL,
	[USERID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_ew4_IntakeAssessmentSites')) is null
CREATE TABLE [OutSystems].[OSUSR_ew4_IntakeAssessmentSites](
	[ID] [bigint] NOT NULL,
	[INTAKEASSESSMENTID] [bigint] NULL,
	[COMPANYSITEID] [bigint] NULL,
	[ETLExecutionKey] [nvarchar](20) NOT NULL
...
if (select object_id('OutSystems.OSUSR_EW4_INTAKECLIENTSATISFACTIONSURVEY')) is null
CREATE TABLE [OutSystems].[OSUSR_EW4_INTAKECLIENTSATISFACTIONSURVEY](
	[ID] [bigint] NOT NULL,
	[CASEID] [bigint] NULL,
	[SERVICE] [nvarchar](50) NULL,
...
if (select object_id('OutSystems.OSUSR_EW4_OUTBOUNDREQUEST')) is null
CREATE TABLE [OutSystems].[OSUSR_EW4_OUTBOUNDREQUEST](
	[ID] [int] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_GYR_CLINIC')) is null
CREATE TABLE [OutSystems].[OSUSR_GYR_CLINIC](
	[ID] [bigint] NOT NULL,
...
if (select object_id('OutSystems.OSUSR_gyr_ClinicCompanyContract1')) is null
CREATE TABLE [OutSystems].[OSUSR_gyr_ClinicCompanyContract1](
	[ID] [bigint] NOT NULL,
	[CLINICID] [bigint] NULL,
	[COMPANYID] [bigint] NULL,
	[CONTRACTID] [bigint] NULL,
...
if (select object_id('OutSystems.OSUSR_hi4_Ethnicity')) is null
CREATE TABLE [OutSystems].[OSUSR_hi4_Ethnicity](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_hi4_Gender')) is null
CREATE TABLE [OutSystems].[OSUSR_hi4_Gender](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_hi4_Language')) is null
CREATE TABLE [OutSystems].[OSUSR_hi4_Language](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_hi4_MaritalStatus')) is null
CREATE TABLE [OutSystems].[OSUSR_hi4_MaritalStatus](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_hi4_Province')) is null
CREATE TABLE [OutSystems].[OSUSR_hi4_Province](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_hi4_Province_Test')) is null
CREATE TABLE [OutSystems].[OSUSR_hi4_Province_Test](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_hi4_Relationship')) is null
CREATE TABLE [OutSystems].[OSUSR_hi4_Relationship](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_hi4_ServiceType')) is null
CREATE TABLE [OutSystems].[OSUSR_hi4_ServiceType](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
...
if (select object_id('OutSystems.OSUSR_o9h_Tenure')) is null
CREATE TABLE [OutSystems].[OSUSR_o9h_Tenure](
	[ID] [int] NOT NULL,
	[LABEL] [nvarchar](50) NULL,
	[ORDER] [int] NULL,
	[IS_ACTIVE] [bit] NULL,
